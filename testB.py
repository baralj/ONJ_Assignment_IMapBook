...
def predictModelB(question, response, model, truth, vocab_size=5000, num_compare=3):
    ...
    for k in range(num_compare):
        sequences2 = [hashing_trick(truth["Best_Responses"][idx][k], vocab_size, hash_function='md5')]
...
def main():
    ...
    for i in range(len(train_data["Question"])):
        ...
        sim = predictModelB(ques, resp, loaded_model, truth)
